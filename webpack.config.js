...
const {
  ...
  XDAI_PROVIDER_URL,
  ZKTEST_PROVIDER_URL,
  SCROLLTESTNET_PROVIDER_URL,
  BASETESTNET_PROVIDER_URL,
  SHARDEUMTESTNET_PROVIDER_URL,
  FAUCET_TOKEN,
  GA_TRACKING_ID,
  FB_TRACKING_ID,
} = process.env;
...
module.exports = {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      ...
      ZKTEST_PROVIDER_URL: JSON.stringify(ZKTEST_PROVIDER_URL),
      SCROLLTESTNET_PROVIDER_URL: JSON.stringify(SCROLLTESTNET_PROVIDER_URL),
      BASETESTNET_PROVIDER_URL: JSON.stringify(BASETESTNET_PROVIDER_URL),
      SHARDEUMTESTNET_PROVIDER_URL: JSON.stringify(SHARDEUMTESTNET_PROVIDER_URL),
